...
for file in "${project_dir}/${CI_PROJECT_NAME}-"*; do
    ...
    # --capath: Workaround curl not reading system-wide trust store
    # git no longer falls back to system SSL certificate store in Alpine 3.21 (#16980) · Issues · alpine / aports · GitLab
